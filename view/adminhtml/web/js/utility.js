    ...
    return  {
        ...
        showAlert(title, message, type, reload_when_close, ok_callback, buttons) {
          if (typeof message == "undefined") {
            message = $.mage.__("Error");
          }
          if (type === "S") {
            var icon = '<div class="md-success" style="color: green;font-size: 50px;"><i class="fa fa-check-circle" aria-hidden="true"></i></div><br />';
          } else if (type === "F") {
            var icon = '<div class="md-success" style="color: red;font-size: 50px;"><i class="fa fa-times-circle" aria-hidden="true"></i></div><br />';
          } else {
            var icon = '';
          }
